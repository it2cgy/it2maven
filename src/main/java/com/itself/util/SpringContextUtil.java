...
//	private static ApplicationContext applicationContext = new ClassPathXmlApplicationContext("application-context.xml"); ;
	...
	private static ApplicationContext  contextSet = null;
	
	  
	public static void setContextSet(ApplicationContext applicationContext) {
		SpringContextUtil.contextSet = applicationContext;
	}
